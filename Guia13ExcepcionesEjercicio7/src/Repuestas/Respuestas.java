...
sentencia_b3: Se ejecuta si se produce la excepción MioException, es decir, si 
se lanza dicha excepción en el bloque try.
sentencia_b4: Se ejecuta después del bloque try-catch, independientemente de si 
