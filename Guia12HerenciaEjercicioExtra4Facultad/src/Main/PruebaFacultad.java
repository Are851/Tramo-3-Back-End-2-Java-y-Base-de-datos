...
public class PruebaFacultad {
    public static void main(String[] args) {
        Estudiante estudiante = new Estudiante("Juan", "Pérez", "123456789", "Soltero", "Informática");
        Profesor profesor = new Profesor("María", "López", "987654321", "Casada", 2010, 102, "Matemáticas");
        PersonalServicio personalServicio = new PersonalServicio("Pedro", "Gómez", "456789123", "Soltero", 2005, 202, "Biblioteca");
        ...
        profesor.reasignarDespacho(103);
